...
resource "yandex_iam_service_account" "vvot19-sa" {
  name        = "vvot19-sa"
...
resource "yandex_iam_service_account_static_access_key" "sa-static-key" {
  service_account_id = yandex_iam_service_account.vvot19-sa.id
}
...
resource "yandex_resourcemanager_folder_iam_binding" "binding-iam" {
  ...
  members = [
    "serviceAccount:${yandex_iam_service_account.vvot19-sa.id}",
  ]
}
